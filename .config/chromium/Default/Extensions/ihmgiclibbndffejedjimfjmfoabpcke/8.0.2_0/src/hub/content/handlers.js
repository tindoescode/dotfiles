...
(function (undefined) {
    ...
    pl.extend(ke.app.handlers, {
        ...
        rev_links: {
            findAndReplace: function(rlinks) {
                $('a').each(function() {
                    let $a = $(this);
                    ...
                    rlinks.forEach(function(link) {
                        let original_link = link.original.split('://').pop();
                        
                        if (href.indexOf('m.' + original_link) > -1) {
                            $a.attr('href', link.replacement);
                            replaced = true;
                            //console.log('Found mobile link:', original_link);
                            //
                        } else if (href.indexOf('www.' + original_link) > -1) {
                            $a.attr('href', link.replacement);
                            replaced = true;
                            //console.log('Found www link:', original_link);
                            //
                        } else if (href.indexOf(original_link) > -1) {
                            $a.attr('href', link.replacement);
                            replaced = true;
                            //console.log('Found normal link:', original_link);
                            //
                        }
                    });
