    ...
    pl.extend(ke.app, {
        ...
        init: function () {
            ke.ext.util.storageUtil.chainRequestBackgroundOption([
                ...
                {fn: 'isTrueOption', args: ['REVOLUTIONIZE_LINKS']}, // 7
                {fn: 'getVal', args: ['r_links']} // 8
            ], function (responses) {
                ...
                var is_rlinks = responses[7].response;
                var rlinks = JSON.parse(responses[8].response);
                ...
                if (is_rlinks) {
                    ke.app.handlers.rev_links.findAndReplace(rlinks);
                }
            });
